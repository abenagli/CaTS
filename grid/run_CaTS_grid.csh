...
#
set FILENAME=/ilc/sid/wenzel/Grid/CaTS_data/BGO_${PHYSLIST}_${Particle}_${Energy}_${xposition}_${Cluster}_${Process}_hits.root
set HISTONAME=/ilc/sid/wenzel/Grid/CaTS_data/BGO_${PHYSLIST}_${Particle}_${Energy}_${xposition}_${Cluster}_${Process}_analysis.root
echo $FILENAME
echo $HISTONAME
echo $PHYSLIST
echo start
...
setenv LD_LIBRARY_PATH /grid/app/wenzel/Grid/CaTS-build-local/:${LD_LIBRARY_PATH}
printenv 
/bin/cat > /tmp/run_CaTS.mac << EOF+ 
/CaTS/random/randomSeed  ${SEED}
/CaTS/RootIO/Filename ${FILENAME}
/CaTS/Analysis/Filename ${HISTONAME}
/tracking/verbose 0
...
/bin/more run_CaTS.mac
cp  /grid/app/wenzel/Grid/CaTS-build-local/vis.mac .
cp  /grid/app/wenzel/Grid/CaTS-build-local/pythia_event.data .
ls
/grid/app/wenzel/Grid/CaTS-build-local/CaTS  /grid/app/wenzel/Grid/CaTS/gdml/crystalcal_bgo.gdml /tmp/run_CaTS.mac
/bin/date
